...
/*!
    \class HistoryLimitByVisitsModel
    \brief Identity model that limits the number of rows returned by a history
    model ordened by visits

    HistoryLimitByVisitsModel is a proxy model that limits the number
    of rows returned by a HistoryByVisitsModel
    (i.e. only the first N history are returned).
*/
HistoryLimitByVisitsModel::HistoryLimitByVisitsModel(QObject* parent)
...
HistoryByVisitsModel* HistoryLimitByVisitsModel::sourceModel() const
{
    return qobject_cast<HistoryByVisitsModel*>(QIdentityProxyModel::sourceModel());
}

void HistoryLimitByVisitsModel::setSourceModel(HistoryByVisitsModel* sourceModel)
{
...
int HistoryLimitByVisitsModel::rowCount(const QModelIndex &parent) const
{
...
int HistoryLimitByVisitsModel::limit() const
{
    return m_limit;
}

void HistoryLimitByVisitsModel::setLimit(int limit)
{
    if (limit != m_limit) {
...
void HistoryLimitByVisitsModel::sourceRowsAboutToBeInserted(const QModelIndex &parent, int start, int end)
{
    if (m_limit < 0) {
...
void HistoryLimitByVisitsModel::sourceRowsAboutToBeRemoved(const QModelIndex &parent, int start, int end)
{
    if (m_limit < 0) {
...
void HistoryLimitByVisitsModel::sourceRowsInserted(const QModelIndex & /*parent*/, int /*start*/, int /*end*/)
{
...
void HistoryLimitByVisitsModel::sourceRowsRemoved(const QModelIndex & /*parent*/, int /*start*/, int /*end*/)
{
    if (m_sourceRemoving) {
        endRemoveRows();
        m_sourceRemoving = false;

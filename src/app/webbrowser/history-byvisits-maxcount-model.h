...
#ifndef __HISTORY_BYVISITS_MAXCOUNT_MODEL_H__
#define __HISTORY_BYVISITS_MAXCOUNT_MODEL_H__
...
class HistoryByVisitsMaxCountModel : public QSortFilterProxyModel
{
    Q_OBJECT
...
#endif // __HISTORY_BYVISITS_MAXCOUNT_MODEL_H__
